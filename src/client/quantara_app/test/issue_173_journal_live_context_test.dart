...
void main() {
  ...
  test('latest public analysis and setup are exposed to Journal by strategy', () {
  ...
  test('Journal source keeps frozen plan separate from live chart context', () {
    ...
    final issue172 = File('test/issue_172_physical_qa_regression_test.dart')
        .readAsStringSync();
    ...
    expect(livePanel, contains('Support/resistance zones on the chart are from current live analysis'));
