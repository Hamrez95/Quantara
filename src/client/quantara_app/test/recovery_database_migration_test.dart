...
void main() {
  test('migrates every supported schema without losing durable records', () async {
    ...
    await v1.put(
      QuantaraDurableRecord(
        ...
        payload: const {'symbols': ['BTCUSDT', 'XRPUSDT'], 'risk': 0.5},
      ),
    );
    await v1.close();
  ...
  test('failed migration rolls back and preserves the previous database', () async {
    final factory = databaseFactoryMemory;
  ...
  test('secret records are rejected by the durable database boundary', () async {
