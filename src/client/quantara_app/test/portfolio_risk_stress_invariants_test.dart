...
void main() {
  test('randomized concurrent reservations never overbook durable daily risk', () async {
    ...
    for (var round = 0; round < 12; round++) {
      ...
      final acceptedRisk = outcomes
          ...
          .fold<double>(0, (sum, outcome) => sum + outcome.decision.maximumLoss);
  ...
  test('gap repricing and flash slippage exhaust risk before another entry', () async {
