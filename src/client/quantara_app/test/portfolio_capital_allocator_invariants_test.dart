...
void main() {
  ...
  test(
    'duplicate proposal identity fails closed before evidence is ambiguous',
    () {
  ...
  test(
    'randomized allocations preserve aggregate risk and margin ceilings',
    () {
      ...
      for (var round = 0; round < 64; round++) {
        ...
        expect(
          decision.riskConsumed,
          lessThanOrEqualTo(allocatableRisk + 1e-9),
        );
        expect(
