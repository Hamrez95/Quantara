...
void main() {
  test('Trading Lab paper execution has no private exchange write dependency', () {
    final files = [
      File('lib/features/trading_lab/application/trading_lab_paper_broker.dart'),
      File('lib/features/trading_lab/application/trading_lab_controller.dart'),
  ...
  test('Trading Lab export source keeps explicit credential redaction keys', () {
    final source = File(
