...
void main() {
  TradingPnlProjection solProjection({
    String entryClientId = 'q-local-deadbeef',
  }) {
  ...
  test(
    ...
    () {
      ...
      expect(
        ...
        isNot(TradingJournalIntegrity.unverified),
      );
      ...
      final projection = TradingJournalProjector.projectAll(
        result.ledger,
      ).single;
