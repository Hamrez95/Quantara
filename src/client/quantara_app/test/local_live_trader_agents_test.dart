...
void main() {
  ...
  group('Trader Agent Lab · local live canary', () {
    ...
    test('Nima active scalper can select 15m without expanding concurrency', () {
    ...
    test('Sara risk manager blocks excessive risk and concurrency', () {
      expect(
        () => configuration(risk: 0.30).validate(),
    ...
    test('Kian Bitunix operator verifies signed entry and emergency close paths', () async {
    ...
    test('Mina accessibility auditor finds explicit Start, Stop, and locked server labels', () {
      final view = File(
    ...
    test('Reza chaos trader forces exchange failures into a safe exception', () async {
      final api = BitunixLocalLiveApiClient(
        client: MockClient(
    ...
    test('Leila strategy researcher preserves selected strategy and cadence', () {
    ...
    test('Omid execution auditor blocks forbidden authority and verifies full protection gates', () {
